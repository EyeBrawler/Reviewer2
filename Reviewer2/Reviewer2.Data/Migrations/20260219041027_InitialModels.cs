        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DecisionMadeAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DecisionMadeByUserId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Papers_AspNetUsers_SubmitterUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPresenter = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReviewAssignments_Papers_PaperId",
                        column: x => x.PaperId,
                        principalTable: "Papers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ReviewTemplateId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reviews_ReviewTemplates_ReviewTemplateId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Authors_PaperId_AuthorOrder",
                table: "Authors",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Papers_SubmitterUserId",
                table: "Papers",
                column: "SubmitterUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ReviewAssignments_PaperId_ReviewerId",
                table: "ReviewAssignments",
                columns: new[] { "PaperId", "ReviewerId" },
                unique: true);
